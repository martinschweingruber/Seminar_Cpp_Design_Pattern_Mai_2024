...
namespace WeakPointer {
    ...
    static void test_01() {
        ...
        std::weak_ptr<const int> weakPtr;

        {
            ...
            std::shared_ptr<const int> ptr2{ weakPtr.lock() };
            if (ptr2 != nullptr) {
        ...
        if (std::shared_ptr<const int> ptr3 = weakPtr.lock(); ptr3 == nullptr) {
